...
section {
    ...
    width: 100%;
    padding: 200px 5rem;
    background: linear-gradient(0deg, rgba(0, 0, 0, 0.73) 0%, rgba(0, 0, 0, 0.73) 100%), url(/src/assets/images/case/808feb3d2aa6a887c31c4f714e41ad3e.png) no-repeat center center;
    display: flex;
    align-items: center;
